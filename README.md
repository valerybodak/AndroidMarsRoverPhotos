# Mars Rover Photos (Clean Architecture)
...
This repository contains a detailed sample app that implements Clean Architecture using Kotlin, Room, Koin, RxJava etc. Based on Open NASA's API (https://api.nasa.gov)
